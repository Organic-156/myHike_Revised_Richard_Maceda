//Getting the name and displaying it on the page

// earlier version of code -Richard
    ...
    db.collection(collection).get()   //the collection called "hikes"
        .then(allHikes => {
            ...
            allHikes.forEach(doc => { //iterate thru each doc
                ...
                // newcard.querySelector('i').onclick = () => unBookmark(docID); supposed to remove 
...
// --------------------------------------------------------------------------------
//this calls all the function above
// --------------------------------------------------------------------------------
...
function updateBookmark(hikeId) {
    currentUser.get().then((userDoc) => {
        ...
        // if statement is to remove, and else is to add to the database
        if (isBookmarked) {
            console.log("this item exists");
            currentUser.update({
                bookmarks: firebase.firestore.FieldValue.arrayRemove(hikeId)
            }).then(() => {
                console.log("Document successfully removed then updated!");
            ...
            currentUser.update({
                ...
                console.log("Document successfully added then updated!");
